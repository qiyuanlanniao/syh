...
class PayOrderItem(db.Model):
    ...
    price = db.Column(db.Numeric(10, 2), nullable=False, info='商品总价格，售价 * 数量')
    food_id = db.Column(db.Integer, nullable=False, index=True, server_default=db.FetchedValue(), info='商品表id')
