...
class PayOrder(db.Model):
    ...
    total_price = db.Column(db.Numeric(10, 2), nullable=False, info='订单应付金额')
    yun_price = db.Column(db.Numeric(10, 2), nullable=False, info='运费金额')
    pay_price = db.Column(db.Numeric(10, 2), nullable=False, info='订单实付金额')
    ...
    pay_deadline = db.Column(db.DateTime, nullable=True, server_default=db.FetchedValue(), info='支付截止时间')  # nullable=True
